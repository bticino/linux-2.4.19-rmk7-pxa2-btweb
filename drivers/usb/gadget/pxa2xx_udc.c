...
#ifdef	CONFIG_PM
static int udc_pm(struct pm_dev *dev, pm_request_t rqst, void *data)
{
	struct pxa2xx_udc *udc_dev = the_controller;
...
static int __init init(void)
{
	...
	create_proc_files();
#ifdef	CONFIG_PM
	pm = pm_register(PM_SYS_DEV, PM_SYS_UNKNOWN, udc_pm);
#endif
